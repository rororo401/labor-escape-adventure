...
OUTPUT_PATH = ROOT / "data/game/phase2_image_queue.generated.json"
...
def main() -> int:
    ...
    payload = {
        "version": 1,
        "note": "Generated image production queue for Phase 2 event CG. Missing assets are sorted first.",
